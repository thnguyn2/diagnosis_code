...
if (~exist('svmstruct_ws120.mat','file'))
    if (~exist('sampleddata_ws120.mat','file'))
        for classidx=1:4 %Go through different classes
               ...
               for sampleIdx=1:nsamples
                    ...
                    tx_hist_file_name = strcat(label_name,'_texton_hist_120.mat');
        ...
        save('sampleddata_ws120.mat','data','label','filelist');
    else
        load('sampleddata_ws120.mat');
    end
    ...
    save 'svmstruct_ws120.mat' svmtruct;
    ...
    switch testmode
        case 1
            load('sampleddata_ws120.mat','data','label');
        ...
        case 2
            ...
            for classidx=1:4 %Go through different classes
               ...
               for sampleIdx=1:nsamples
                    ...
                    disp(['Adding data of: ' label_name ' ...']);
                    tx_hist_file_name = strcat(label_name,'_texton_hist_120.mat');
                    svm_file_name = strcat(label_name,'_svm_200k_ws120.mat');
